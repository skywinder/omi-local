...
def is_offline_runtime(environ: dict[str, str] | None = None) -> bool:
    """Return whether provider/network-dependent backend paths must fail closed."""

    return stage_from_env(environ) == EnvStage.OFFLINE.value
