...
Mac» и на экране текущей записи. Она обновляется примерно раз в 5 секунд,
пока экран открыт, и по кнопке обновления. Сначала выполните «Проверить и подключить».
