...
2. Дождитесь подготовки Mac. Введите HTTPS-адрес и authtoken из кабинета ngrok.
...
Повторный запуск использует прежние настройки. После запуска Terminal можно закрыть.
...
**▶ Начать запись**, в конце — **■ Остановить запись**. Мьют временно выключает
